...
export default class Powcaptcha{static tmpFolder=process?.env?.POWCAPTCHA_TMPFOLDER;static crypto;static async createChallenge(puzzles=50){const crypto=this.getCrypto();const arr=[];for(let i=0;i<puzzles;i++){arr.push(this.byteArrayToHex(crypto.getRandomValues(new Uint8Array(16))));}
return arr.join('');}
